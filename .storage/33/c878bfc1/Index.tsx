    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-50">
        ...
        <section className="py-16 px-4 sm:px-6 lg:px-8 bg-blue-600 text-white">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl mb-8">
              Join thousands of families who trust Dec'sNanny for their childcare needs
            </p>
            <div className="space-x-4">
              <Button size="lg" variant="secondary" onClick={() => navigate('/register')}>
                Sign Up as Parent
              </Button>
              <Button size="lg" variant="outline" className="text-white border-white hover:bg-white hover:text-blue-600" onClick={() => navigate('/register')}>
                Join as Nanny
              </Button>
            </div>
          </div>
      ...
      <footer className="bg-gray-900 text-white py-12 px-4 sm:px-6 lg:px-8">
        <div className="max-w-6xl mx-auto text-center">
          <h4 className="text-2xl font-bold mb-4">Dec'sNanny</h4>
