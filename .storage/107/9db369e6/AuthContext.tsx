...
export function AuthProvider({ children }: AuthProviderProps) {
      ...
      const initialBookings: Booking[] = [
        {
          ...
          startTime: '09:00',
          endTime: '17:00',
          children: [{ name: 'Emma', age: 5 }, { name: 'Jake', age: 3 }],
          specialInstructions: 'Emma has a nut allergy. Snacks are in the kitchen.',
          status: 'pending',
          hourlyRate: 25,
          totalAmount: 200,
  ...
  const login = async (email: string, password: string, userType: 'parent' | 'nanny'): Promise<boolean> => {
    try {
      ...
      const userId = userType === 'parent' ? 'parent-demo' : 'nanny-demo';
